...
module ApiMocking
  def mock_books(auth_token)
    stub_request(:get, %(#{ENV["BOOKSHELF_API_URL"]}/v1/books))
      .with(
        headers: {
  ...
  def mock_variants(auth_token, product_id)
    stub_request(:get, %(#{ENV["BOOKSTORE_API_URL"]}/api/v1/variants?filter[product_id]=#{product_id}))
      .with(
        headers: {
          "Accept" => "application/vnd.api+json",
          "Content-Type" => "application/vnd.api+json",
  ...
  def mock_categories(auth_token)
    stub_request(:get, %(#{ENV["BOOKSTORE_API_URL"]}/api/v1/categories))
      .with(
        headers: {
          "Accept" => "application/vnd.api+json",
          "Content-Type" => "application/vnd.api+json",
  ...
  def mock_publishers(auth_token)
    stub_request(:get, %(#{ENV["PUBLISHER_API_URL"]}/v1/publishers))
      .with(
        headers: {
          "Accept" => "application/vnd.api+json",
          "Content-Type" => "application/vnd.api+json",
  ...
  def mock_authors(auth_token)
    stub_request(:get, %(#{ENV["AUTHOR_API_URL"]}/v1/authors))
      .with(
        headers: {
          "Accept" => "application/vnd.api+json",
          "Content-Type" => "application/vnd.api+json",
  ...
  def mock_author(auth_token, uuid)
    stub_request(:get, %(#{ENV["AUTHOR_API_URL"]}/v1/authors/#{uuid}))
      .with(
        headers: {
          "Accept" => "application/vnd.api+json",
          "Content-Type" => "application/vnd.api+json",
